...
class RemoteSessionHandler(Protocol):
    ...
    # Interactive shell methods are transport-sensitive. Non-PTY transports such
    # as WinRM may raise NotImplementedError here; the MCP layer converts that
    # capability boundary into a structured unsupported_operation response.
